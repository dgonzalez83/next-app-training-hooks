...
export default function Home() {
  return (
    <>
      ...
      <ul>
        <li>
          <strong>Completamente opcionales.</strong> Puedes probar Hooks en unos
          pocos componentes sin reescribir ningún código existente. Pero no
          tienes que aprender o usar Hooks ahora mismo si no quieres.
        </li>
        <li>
          <strong>100% compatibles con versiones anteriores.</strong> Los Hooks
          no tienen cambios con rupturas con respecto a versiones existentes.
        </li>
        <li>
      ...
      <p>
        ...
        conceptos que ya conoces de React: props, estado, contexto, referencias,
        y ciclo de vida. Como veremos más adelante, los hooks también ofrecen
        una nueva y poderosa forma de combinarlos.
      </p>
    </>
  );
}
